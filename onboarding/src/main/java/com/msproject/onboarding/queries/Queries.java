...
//	public static final String INSERT_QUERY= "INSERT INTO "+ OnboardingTableConstants.TABLE_NAME + "("
//			+ OnboardingTableConstants.NAME + " , " + OnboardingTableConstants.EMAIL + " , " + OnboardingTableConstants.DOB + " , " 
//			+ OnboardingTableConstants.CONTACT + " , "+ OnboardingTableConstants.ADDRESS + " , " + OnboardingTableConstants.DEMANDID + ", " 
//			+ OnboardingTableConstants.LOCATION + " , "+ OnboardingTableConstants.SKILLS + " , "+ OnboardingTableConstants.ETA + ", "
//			+ OnboardingTableConstants.BGC_STATUS + " , " + OnboardingTableConstants.ONBOARDING_STATUS + " , " + OnboardingTableConstants.ONBOARDING_DATE + ", "
//			+ OnboardingTableConstants.MS_HIRING_MANAGER + " , " + OnboardingTableConstants.CREATION_TM + " , " + OnboardingTableConstants.LAST_MODIFIED_TM + " , " 
//			+ OnboardingTableConstants.DESIGNATION + ", "+ OnboardingTableConstants.EXPERIENCE + " , " + OnboardingTableConstants.GRADUATION;
